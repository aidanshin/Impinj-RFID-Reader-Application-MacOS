    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                TruncatedReplySettings truncReply = settings.TruncatedReply;
                truncReply.IsEnabled = true;        // Enable Truncated Reply
                truncReply.BitPointer = 32;         // Start at the beginning of the EPC
                truncReply.Gen2v2TagsOnly = false;  // Do NOT request only Gen2V2 tags respond
                truncReply.EpcLengthInWords = 6;    // Only 96 bit EPC tags will be decoded successfully
                truncReply.TagMask = "E280";        // Tags whose EPC begins with E280 will be the ones that truncate their replies
